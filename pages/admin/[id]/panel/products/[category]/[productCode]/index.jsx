		...
		<div>
			...
			<div className="flex flex-col w-full min-h-screen px-40 py-20 gap-11 bg-ivory">
				<div className="flex flex-col justify-center w-full h-20 px-6 shadow-xl rounded-2xl bg-green">
					<p className="text-3xl font-Comfortaa text-charleston">Producto {item.productCode} </p>
					<p>Volver</p>
					...
					<div className="flex flex-col gap-5">
						<div className="grid w-full h-40 grid-cols-6 grid-rows-1 gap-3 px-4 py-3 shadow-xl hover:bg-ivory bg-cornsilk rounded-2xl">
							...
							<div className="flex flex-col justify-center col-start-2 col-end-6">
								<p className="text-sm font-Comfortaa text-charleston">{item.name}</p>
								<p className="text-sm font-Comfortaa text-charleston">Código de producto: {item.productCode} </p>
								<p className="text-sm font-Comfortaa text-charleston">Tipo: {item.category}</p>
								<p className="text-sm font-Comfortaa text-charleston">Material: {item.material}</p>
								<p className="text-sm font-Comfortaa text-charleston">Temporada: {item.season}</p>
							</div>
						...
						<div className="w-full h-auto px-4 py-3 shadow-xl bg-cornsilk rounded-2xl">
							<p className="font-bold ">Tallas</p>
							{
								item.sizes.map(({ size, stock, prize }) => (
									<div key={size} className="px-4 py-3 border-b-2 shadow-xl border-charleston bg-ivory rounded-xl">
										<p>Talla {size}</p>
