...
const UserLogin = () => {
	...
	function handleSubmit(e) {
		...
		signInWithEmailAndPassword(auth, email, password).then(() => { window.alert("Sesión iniciada con éxito"); router.push('/') }).catch((error) =>{ window.alert(`Correo o contraseña incorrectos`); router.reload()})
	}
