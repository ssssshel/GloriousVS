    ...
    <div>
      ...
      <div className="flex flex-col w-full h-auto px-40 py-20 gap-11 bg-ivory">
        ...
        <div className="flex flex-col gap-5">
          <div className="grid w-full h-40 grid-cols-8 grid-rows-1 gap-5 px-4 py-3 shadow-xl bg-cornsilk rounded-xl hover:bg-ivory">
            ...
            <div className="flex flex-col justify-center col-start-2 col-end-7 gap-2">
              <p className="text-sm font-Comfortaa text-charleston">
                Código de venta: fheu734
              </p>
              <p className=" font-Comfortaa text-charleston">Estado:</p>
              <p className="text-sm font-Comfortaa text-charleston">
                Dirección de entrega: Calle Sebastián Barranca 3956, Los Olivos,
                Lima
              </p>
              <p className="text-sm font-Comfortaa text-charleston">
                Fecha de entrega:{" "}
